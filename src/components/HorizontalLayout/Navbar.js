                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <div className={classname("dropdown-menu", { show: this.state.appState })} >
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <li><Link to="crypto-wallet" className="dropdown-item">{this.props.t('Wallet')}</Link></li>
                                                <li><Link to="crypto-buy-sell" className="dropdown-item">{this.props.t('Buy/Sell')}</Link></li>
                                                <li><Link to="crypto-exchange" className="dropdown-item">{this.props.t('Exchange')}</Link></li>
                                                <li><Link to="crypto-lending" className="dropdown-item">{this.props.t('Lending')}</Link></li>
                                                <li><Link to="crypto-orders" className="dropdown-item">{this.props.t('Orders')}</Link></li>
                                                <li><Link to="crypto-kyc-application" className="dropdown-item">{this.props.t('KYC Application')}</Link></li>
                                                <li><Link to="crypto-ico-landing" className="dropdown-item">{this.props.t('ICO Landing')}</Link></li>
                                                </div>
                                            </div>
